...
test('mobile viewport release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=215/);assert.match(index,/src\/app\.js\?v=215/);assert.match(sw,/factory-digital-twin-v215-runtime-recovery-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});