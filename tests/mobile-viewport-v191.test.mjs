...
test('V191 release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=197/);assert.match(index,/src\/app\.js\?v=197/);assert.match(sw,/factory-digital-twin-v209-architecture-convergence-20260925/);assert.match(app,/pair\('Versi aplikasi','2026\.09\.25'\)/);});