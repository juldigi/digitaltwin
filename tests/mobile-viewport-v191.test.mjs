...
test('mobile viewport release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=222/);assert.match(index,/src\/app\.js\?v=222/);assert.match(sw,/factory-digital-twin-v222-overlay-state-ssot-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});