...
test('mobile viewport release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=219/);assert.match(index,/src\/app\.js\?v=219/);assert.match(sw,/factory-digital-twin-v219-cinematic-focus-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});