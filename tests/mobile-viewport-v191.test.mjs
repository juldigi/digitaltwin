...
test('mobile viewport release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=221/);assert.match(index,/src\/app\.js\?v=221/);assert.match(sw,/factory-digital-twin-v221-ui-shell-hardening-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});