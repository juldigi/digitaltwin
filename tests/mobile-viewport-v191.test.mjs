...
test('V191 release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=192/);assert.match(index,/src\/app\.js\?v=192/);assert.match(sw,/factory-digital-twin-v192-mobile-camera-framing-20260923/);assert.match(app,/pair\('Versi aplikasi','V192'\)/);});