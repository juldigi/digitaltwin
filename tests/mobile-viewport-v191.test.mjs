...
test('V191 release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=198/);assert.match(index,/src\/app\.js\?v=198/);assert.match(sw,/factory-digital-twin-v210-architecture-convergence-stage5-20260925/);assert.match(app,/pair\('Versi aplikasi','2026\.09\.25'\)/);});