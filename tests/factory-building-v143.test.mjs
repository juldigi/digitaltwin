...
test('V143 structural baseline survives V144 packaging interior pass',async()=>{
 ...
 built.root.traverse(o=>{if(o.userData?.accuracy==='INDUSTRIAL_REALISM_REFERENCE_NOT_AS_BUILT')assert.equal(o.userData.researchVersion,'V144');});
});

test('V143 open IPAL and utility-routing boundary survive V144',async()=>{
 const [layout,fleet]=await Promise.all([loadActualPlantLayout(),loadFactoryFleet()]);
