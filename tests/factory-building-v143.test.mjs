...
test('V143 structural baseline survives V145 micro-realism pass',async()=>{
 ...
 built.root.traverse(o=>{if(o.userData?.accuracy==='INDUSTRIAL_REALISM_REFERENCE_NOT_AS_BUILT'&&o.userData.researchVersion)assert.match(o.userData.researchVersion,/^V\d+$/);});
});
