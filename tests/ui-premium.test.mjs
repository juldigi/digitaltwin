...
test('V158 loads one unified adaptive shell after the stable base styles',()=>{
  ...
  assert.match(html,/app\.js\?v=168[\s\S]*ui-v5\.js\?v=167[\s\S]*experience-v37\.js\?v=164[\s\S]*app-shell-v79\.js\?v=167/);
...
test('service worker owns the current OEM-deep-detail shell assets',()=>{
 assert.match(sw,/factory-digital-twin-v168-reading-flow-20260923/);
