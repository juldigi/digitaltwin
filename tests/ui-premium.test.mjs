...
test('V158 loads one unified adaptive shell after the stable base styles',()=>{
  assert.match(html,/style\.css[\s\S]*runtime-fallback\.css[\s\S]*app-shell-v79\.css\?v=217/);
  assert.match(html,/app\.js\?v=217[\s\S]*ui-v5\.js\?v=217[\s\S]*experience-v37\.js\?v=217[\s\S]*app-shell-v79\.js\?v=217/);
