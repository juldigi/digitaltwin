...
test('V142 factory architecture keeps measured/user-confirmed envelope while adding reference realism',async()=>{
 ...
 assert.equal(root.userData.buildingDetailPass,'V202_ROOM_ENVELOPE_CLOSURE_AND_DOOR_AWARE_FURNITURE_LAYOUT');
 assert.equal(root.userData.researchVersion,'V202');
