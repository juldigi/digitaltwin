...
test('V184 assets rotate browser and service-worker caches',()=>{
 assert.match(index,/app-shell-v79\.css\?v=184/);
 assert.match(index,/src\/app\.js\?v=184/);
 assert.match(index,/src\/app-shell-v79\.js\?v=184/);
 assert.match(sw,/factory-digital-twin-v184-simulation-overlay-hardening-20260923/);
 assert.match(app,/pair\('Versi aplikasi','V184'\)/);
});
