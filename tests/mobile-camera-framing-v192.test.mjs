...
test('mobile camera release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=217/);assert.match(index,/src\/app\.js\?v=217/);assert.match(sw,/factory-digital-twin-v217-render-foundation-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});