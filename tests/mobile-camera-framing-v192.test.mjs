...
test('mobile camera release identifiers are coherent',()=>{assert.match(index,/app-shell-v79\.css\?v=218/);assert.match(index,/src\/app\.js\?v=218/);assert.match(sw,/factory-digital-twin-v218-mobile-ui-recovery-20260925/);assert.match(app,/pair\('Versi aplikasi',APP_BUILD\)/);});