...
test('V149 state foundation exposes the complete single-state contract',()=>{
 for(const key of ['bootState','activeSection','selectedArea','selectedAsset','selectedNode','selectedSystem','viewMode','cameraPreset','visibleLayers','inspectionMode','simulationState','referenceState','inspectorState','preferences','activeReference','deviceMode']){
