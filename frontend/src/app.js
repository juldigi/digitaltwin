...
function settingsDialog(){
 ...
 $('#low-mode').onchange=e=>{const lowDetail=Boolean(e.target.checked);setPreference('lowDetail',lowDetail);engine?.setLow(lowDetail);};
