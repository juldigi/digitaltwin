...
function enableExteriorOpen({forceDetail=true}={}){
 ...
 engine.template.reset();engine.clearPartLabels();setDomainState({inspectionMode:{isolate:false}});engine.isolated=false;if(forceDetail)engine.setLow(false);engine.template.setExteriorOpen(true);
