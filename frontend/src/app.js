...
function applyMachineShell(){
 ...
 if(IS_OFFSET10){
  ...
  const warning=$('#dwg-warning');if(warning)warning.textContent='Sheeting V194 memakai foto aktual BMJ sebagai visual source of truth: input reel kanan → roller bank → guarded LEXUS cutter → delivery → rack stacker kiri. Posisi plant tetap mengikuti anchor layout yang tervalidasi.';
 }else if(IS_GENERIC){
