  ...
  if(IS_APM2){
   ...
   updateSimulationPanel(s);
    ...
    const flagRows=[
     ...
     ['Air table',s.airTableActive],['Feeder suction',s.feederSuctionActive],['Backgauge motion',s.backgaugeMoving],['Clamp',s.clampActive],['Knife downstroke',s.knifeDownstroke],['Knife upstroke',s.knifeUpstroke],['Coating transfer',s.coatingActive],['Dryer passage',s.dryerActive],['Delivery gripper bars',s.deliveryGripperActive],['Dynamic sheet brake',s.deliveryBrakeActive],['Air separation',s.airingActive],['Jogging / alignment',s.joggingActive],['Reject demo',s.demoRejectActive],['Delivery rake',s.deliveryRakeActive]
