  ...
  if(IS_APM2){
   ...
   updateSimulationPanel(s);
    ...
    const flagRows=[
     ...
     ['Air table',s.airTableActive],['Backgauge motion',s.backgaugeMoving],['Clamp',s.clampActive],['Knife downstroke',s.knifeDownstroke],['Knife upstroke',s.knifeUpstroke],['Air separation',s.airingActive],['Jogging / alignment',s.joggingActive],['Reject demo',s.demoRejectActive],['Delivery rake',s.deliveryRakeActive]
