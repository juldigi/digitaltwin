...
function applyMachineShell(){
 ...
 if(IS_OFFSET10){
  ...
  const qgrid=$('[data-workbench-card="quick"] .quick-grid');if(qgrid)qgrid.innerHTML='<dt>Model plant</dt><dd>HSM-CTM7</dd><dt>Serial</dt><dd>00982</dd><dt>Tahun</dt><dd>2014</dd><dt>SAP Code</dt><dd>SBM-2</dd><dt>Referensi visual</dt><dd>9 foto aktual BMJ IMG_2479–IMG_2487</dd><dt>HSM 56 pembanding</dt><dd>Process/spec only · 300 m/min · 600 gsm</dd><dt>Mekanisme cutter internal</dt><dd>Flat Bed Knife family · stationary bed knife + rotary fly knife · cutaway only</dd><dt>Alur aktual</dt><dd>RIGHT → LEFT</dd>';
  const warning=$('#dwg-warning');if(warning)warning.textContent='Sheeting V196 memakai foto aktual BMJ sebagai visual source of truth. Kinematik proses diperbaiki: web tetap tersambung sampai cross-cut, lembar hasil potong dipercepat untuk membuka gap, lalu diperlambat menjadi overlap/shingle sebelum stacker. Mekanisme bed-knife/fly-knife hanya ditampilkan pada cutaway sebagai referensi keluarga HSM.';
 }else if(IS_GENERIC){
