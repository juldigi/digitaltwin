 ...
 * APM-5 — AUTOPLATEN 5 STAMPING — MK 920 YMI
...
(function(global){
'use strict';
const MACHINE_ID="APM-5";
const SPEC={
  "maxSheetClassMM": 920,
  "process": "hot foil stamping / hologram transfer family",
  "evidence": "MK920YMI documented by Masterwork as foil feeding and hologram transmission"
};
const ENVELOPE_M=[8.65, 3.75, 2.85];
const STATIONS=[
  {
    "id": "feeder",
    "label": "Feeder",
  ...
  {
    "id": "foil_pull",
    "label": "Foil indexing/rewind",
    "x": 5.1,
    "height": 2.05,
    "components": [
      "servo foil pulls",
      "guide rollers",
      "spent foil rewind shafts",
      "tension arms"
    ]
  },
  {
...
function build(T,options={}){if(!T)throw new Error(MACHINE_ID+' requires THREE');const root=new T.Group();root.name=MACHINE_ID;root.userData={machineId:MACHINE_ID,name:"AUTOPLATEN 5 STAMPING",model:"MK 920 YMI",spec:SPEC,taxonomy:taxonomy(),motions:MOTIONS,visualDNA:VISUAL_DNA,evidenceStatus:"REFERENCE_VERIFIED_MODEL_FAMILY"};const mm=materials(T);addBase(T,root,mm);addStations(T,root,mm);addServices(T,root,mm);return root;}
