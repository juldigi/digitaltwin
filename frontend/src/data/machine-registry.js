...
export const MACHINE_REGISTRY=Object.freeze([
  ...
  row('BMJ-MCH-0005',5,'OFFSET PRINTING','OFFSET - 8 MACHINE','CX 104-8+LYYL','XB001916','PC-PK2-OFS-PRT-00OFFSET08','OFS-8',2022,true,'EXCEL + HEIDELBERG_CX104_PRIMARY + BMJ_CONFIGURATION_RECORD','Dedicated CX 104-8+LYYL twin preserves BMJ serial/year/SAP/FLOC and the installed 8 PU + L + Y + Y + L sequence. Official CX 104 limits ground sheet handling and core press architecture. Dryer sections remain energy-neutral because the installed IR/UV/LED technology is not asserted without serial-specific evidence.'),
  row('BMJ-MCH-0006',6,'OFFSET PRINTING','OFFSET - 9 MACHINE','SX52-4+L','GS001804','PC-PK2-OFS-PRT-00OFFSET09','OFS-9',2024,true,'EXCEL + HEIDELBERG_SX52_PRIMARY_REFERENCE','Dedicated SX 52-4+L twin uses official HEIDELBERG architecture and technical limits. BMJ serial/configuration/year come from the site registry. Standard/high-pile delivery choice, UV/dryer, perfector, Anicolor and exact internal roller counts are not inferred until serial-specific evidence is available.'),
  ...
  row('BMJ-MCH-0021',21,'OFFSET CONVERTING','AUTOBLANKING MACHINE 2','QF-100CS','2103072CGB05','PC-PK2-CON-STR-STRIPING02','ABM-2',2022,true,'EXCEL + QF_LQF_1080_FAMILY_PRIMARY_REFERENCES','Identitas QF-100CS/serial/FLOC/SAP/tahun berasal dari workbook BMJ. Public exact-model QF-100CS documentation belum terverifikasi; twin memakai QF/LQF-1080 family process reference untuk moving X/Y platform, fixed hydraulic blanking head, servo/ball-screw/linear-guide motion, photoelectric positioning, honeycomb pin tooling dan PLC/HMI. Jaya Makmur Mesindo secara publik menampilkan QF1080B/QF1080C dan PT Bukit Muria Jaya Karawang/Kudus sebagai customer/partner, sehingga relevansi family lokal meningkat, tetapi ini bukan bukti bahwa ABM-2 dibeli dari JMM atau QF-100CS identik dengan QF1080C/CS. Dual-head, collector/stacker, pressure, speed dan envelope exact unit BMJ tidak diklaim.'),
  ...
  row('BMJ-MCH-0029',29,'UTILITY','COMPRESSOR ATLAS COPCO NO.2',null,null,null,null,null,true,'EXCEL + ATLAS_COPCO_GA_G_FAMILY_PRIMARY','Brand Atlas Copco berasal dari registry BMJ; exact model/kW/VSD/Full Feature belum tersedia. Twin mengikuti GA/G oil-injected family architecture dan tidak dipakai sebagai engineering CAD.'),
  row('BMJ-MCH-0030',30,'UTILITY','COMPRESSOR ATLAS COPCO NO.3',null,null,null,null,null,true,'EXCEL + ATLAS_COPCO_GA_G_FAMILY_PRIMARY','Brand Atlas Copco berasal dari registry BMJ; exact model/kW/VSD/Full Feature belum tersedia. Twin mengikuti GA/G oil-injected family architecture dan tidak mengasumsikan konfigurasi identik dengan Compressor No.2/No.9.'),
  row('BMJ-MCH-0031',31,'UTILITY','COMPRESSOR KAESER NO.4',null,null,null,null,null,true,'EXCEL + KAESER_SIGMA_FAMILY_PRIMARY','Brand KAESER berasal dari registry BMJ; exact model belum tersedia. Twin mengikuti SIGMA fluid-cooled screw family; belt-drive versus 1:1 direct-drive, controller generation, dryer/receiver dan kW tidak diklaim.'),
  row('BMJ-MCH-0032',32,'UTILITY','COMPRESSOR KAESER NO.6',null,null,null,null,null,true,'EXCEL + KAESER_SIGMA_FAMILY_PRIMARY','Brand KAESER berasal dari registry BMJ; exact model belum tersedia. Twin mengikuti SIGMA fluid-cooled screw family; drive type dan installed options tetap evidence-bounded.'),
