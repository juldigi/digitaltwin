const SOURCE_REFS=Object.freeze(['SHEETING-BMJ-DATABASE','SHEETING-HSM56-BW-PDF','SHEETING-HSM56-BW-FULLIMAGE','SHEETING-MEGAMACH-HSM-FAMILY','SHEETING-LEXUS-INDONESIA','SHEETING-CUTMARK-PROCESS-COMPARISON','SHEETING-HSM56-NEAR-SERIAL','SHEETING-GREATWALL-SYNCHRO-VISUAL','SHEETING-RECOVERED-REFERENCE']);
...
add(nodes,'SH.HEAD.SUB.BLOCK.PART.WINDOW','SH.HEAD.SUB.BLOCK.PART',6,'Spesifik Part','Panoramic Window Assembly',['sheeting-window'],'V65 makes this a selectable true aperture: glass, frame and handles have no opaque side slab directly behind them.');
