...
add(nodes,'SH.STACK.SUB.BLOCK.PART.JOG','SH.STACK.SUB.BLOCK.PART',6,'Spesifik Part','Stack Alignment / Jogger Reference',['sheeting-stacker-joggers'],'V66 process-reference geometry adds front/back stop and side jogger motion so sheets square into the pile. These are generic folio-sheeter functions, not claimed as exact HSM-CTM7 hardware.');
