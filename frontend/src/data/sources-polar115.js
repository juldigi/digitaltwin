export const POLAR115_TECHNICAL_SOURCES=Object.freeze([
 ...
 {id:'POLAR-EM-OP-MANUAL',title:'POLAR 92/115/137/155 EMC/EM-MONITOR operating-instruction archive',publisher:'Document archive',url:'https://www.scribd.com/document/1064998278/Polar-92-115-137-155-Emc-Em-Monitor-Instrucciones-de-Funcionamiento',type:'OPERATION_MANUAL_ARCHIVE',confidence:'MODEL_FAMILY_REFERENCE',supports:['EM-MONITOR control-desk architecture','program keys','dimension input','air-table control','pressing-without-cut control','cut interruption and knife-change procedures']},
 {id:'POLAR-115-SAFETY-MANUAL',title:'POLAR 115 operating-manual safety reference',publisher:'Operating-manual archive',url:'https://www.scribd.com/document/878245467/Polar-115ed-Operators-Manual-78-Ed-176ed-e',type:'OPERATION_MANUAL_ARCHIVE',confidence:'MODEL_FAMILY_REFERENCE',supports:['two-handed cutting release with simultaneity control and anti-repeat circuit','cut buttons held until knife is on upstroke','light-barrier obstruction stops clamp and knife','type-115 light-barrier reference','115 clamp-pressure range 150–4500 daN']},
