...
const units=[
 ['FEED','Air Table & Material Handling',[
  ['CENTER','Center chromed air table','polar-feed-center'],['LEFT','Left air side table','polar-feed-left'],['RIGHT','Right air side table','polar-feed-right'],
 ...
 ['SAFETY','Safety System',[
  ['PHOTO','Photoelectric light-barrier arms','polar-safety-photo'],['TWOHAND','Two-hand cut buttons','polar-safety-twohand'],
  ['ESTOP','Emergency stop','polar-safety-estop'],['REAR','Rear guard reference','polar-safety-rear']
 ]],
 ['CONTROL','EM-MONITOR Control',[
  ['CRT','CRT monitor','polar-control-crt'],['PANEL','Central program / dimension keypad','polar-control-panel'],
