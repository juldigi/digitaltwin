...
const branches={
 ...
 FORM:[['BOTTOM','Crash-lock folding architecture','media100-form-bottom'],['SERVO','Back-fold / corner-conversion mounting zone · installed package unverified','media100-form-servo'],['BELT','Forming belts','media100-form-belts']],
 GLUE:[['LOWER','Lower disc-glue functional reference','media100-glue-lower'],['UPPER','Upper glue-head mounting rail · installed head count unverified','media100-glue-upper'],['PUMP','Glue supply / pump interface','media100-glue-pump']],
 FINAL:[['TROMBONE','Trombone belts','media100-final-trombone'],['FOLD','Final folding rails','media100-final-fold'],['KICK','Kicker / spacing interface reference · installation unverified','media100-final-kicker']],
 ...
 DRIVE:[['MOTOR','Main drive motor','media100-drive-motor'],['TRANSMISSION','Line shaft / transmission reference','media100-drive-transmission'],['CONTROL','Control console reference · generation unverified','media100-drive-control']],
