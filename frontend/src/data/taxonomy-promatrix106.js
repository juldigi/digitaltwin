...
for(const [id,name,ref] of [
 ['FEED','Non-stop feeder','pm106-feeder'],['TABLE','Suction-belt feed table and register','pm106-feedtable'],['TRANSPORT','Seven-bar registered gripper transport','pm106-transport'],
...
const branches={
 ...
 TRANSPORT:[['CHAIN','Intermittent gripper chains and sprockets','pm106-transport-chain'],['BAR','Seven registered gripper bars','pm106-transport-bar'],['REGISTER','Station register / repeatable-stop references','pm106-transport-register']],
 ...
 DELIVERY:[['RAKE','Auto-Non-Stop rake functional reference','pm106-delivery-rake'],['PALLET','Automatic pallet handling architecture','pm106-delivery-pallet'],['SAMPLE','Sample-sheet removal path','pm106-delivery-sample']],
