...
for(const m of OFFSET8_MODULE_SEQUENCE){
 ...
 [['CYL','Plate, blanket, impression and transfer',[ref+'-cylinders']],['INK','Ink fountain, train, four distributors and four form rollers',[ref+'-inking']],['DAMP','Alcolor five-roller dampening',[ref+'-dampening']],['SHEET','Gripper transfer and sheet guidance',[ref+'-sheet']]]:
 m.type==='coat'?
 [['CHAMBER','Chambered doctor blade and supply',[ref+'-chamber']],['ANILOX','Anilox metering roller',[ref+'-anilox']],['APPLY','Coating blanket and impression cylinders',[ref+'-apply']]]:
 [['AIR','Dryer cassette and airflow plenum',[ref+'-air']],['GUIDE','Sheet guide and clearance path',[ref+'-guide']],['EXHAUST','Extraction manifold',[ref+'-exhaust']]];
