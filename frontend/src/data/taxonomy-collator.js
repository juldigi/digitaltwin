const SRC=Object.freeze([
 ...
 'V138-HORIZON-VACL1000',
 'V138-HORIZON-VAC1000-JP'
]);
const rows=[];
...
chain(u,'AIRCTRL','Per-Bin Separation-Air Adjustment','Air Adjustment Block','Bin Air Control Group','Individual Air Adjuster / Nozzle Reference','collator-bin-air','Horizon close-family references document per-bin/independent air adjustment; BMJ topology is not identified.');
...
chain(u,'SUCTIONCTRL','Suction Air Control','Suction Control Block','Vacuum Control Service Group','Blower Motor / Gauge / Bin Suction Adjusters','collator-vacuum-blower','Suction and separation air are modeled as distinct functional controls; exact BMJ blower/control design is unverified.');
...
chain(u,'DOUBLE','Double / Miss Feed Detection','Feed Integrity Block','Double-Feed Sensor Group','IR Emitter / Receiver Feed Sensor Reference','collator-double-feed','Horizon VAC-1000 documents high-intensity infrared double-feed sensing per bin; BMJ sensor implementation is unverified.');
