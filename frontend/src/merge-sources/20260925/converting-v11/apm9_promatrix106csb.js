 ...
 * APM-9 — AUTOPLATEN 9 STRIPPING & BLANKING — Promatrix 106 CSB
...
const ENVELOPE_M=[8.2, 4.48, 2.72];
const STATIONS=[
  {
    "id": "feeder",
  ...
  },
  {
    ...
    "components": [
      "chase",
      "fine-adjust cutting plate",
      "pressure mechanism",
      "pneumatic window lock"
    ]
  },
  {
    "id": "stripping",
