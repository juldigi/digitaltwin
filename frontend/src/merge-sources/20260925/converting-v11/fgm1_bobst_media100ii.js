 ...
 * FGM-1 — FOLDER GLUER 1 — BOBST MEDIA 100 II
...
const ENVELOPE_M=[12.5, 2.3, 2.65];
const STATIONS=[
  {
    "id": "feeder",
    "label": "Feeder",
  ...
  },
  {
    ...
    "height": 0.86,
    "components": [
      "left/right belt arms",
      "folding rails",
      "prebreak hooks",
      "upper hold-down belts"
    ]
  },
  {
    "id": "lockbottom",
    "label": "Crash-lock / 4-6 corner",
    "x": 3.65,
    "height": 0.88,
    "components": [
      "servo folding hooks",
  ...
  {
    "id": "compress",
    "label": "Compression conveyor",
    "x": 10.15,
    "height": 0.84,
    "components": [
      "upper/lower press belts",
      "counting sensor",
      "shingled output"
    ]
  }
...
function build(T,options={}){if(!T)throw new Error(MACHINE_ID+' requires THREE');const root=new T.Group();root.name=MACHINE_ID;root.userData={machineId:MACHINE_ID,name:"FOLDER GLUER 1",model:"BOBST MEDIA 100 II",spec:SPEC,taxonomy:taxonomy(),motions:MOTIONS,visualDNA:VISUAL_DNA,evidenceStatus:"REFERENCE_VERIFIED_MODEL_FAMILY"};const mm=materials(T);addBase(T,root,mm);addStations(T,root,mm);addServices(T,root,mm);return root;}
