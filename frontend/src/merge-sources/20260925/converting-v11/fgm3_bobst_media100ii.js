 ...
 * FGM-3 — FOLDER GLUER 3 — BOBST MEDIA 100 II
...
const SPEC={
  ...
  "solidBoard": "100–600 g/m²"
};
const ENVELOPE_M=[11.8, 2.2, 2.6];
const STATIONS=[
  {
    "id": "feeder",
    "label": "Feeder",
  ...
  },
  {
    ...
    "components": [
      "belt arms",
      "folding rails",
      "upper pressure belts"
    ]
  },
  {
    "id": "corner",
    "label": "4/6 corner & lockbottom",
    "x": 3.45,
    "height": 0.87,
    "components": [
      "servo hook system",
      "corner belts",
      "timed folding fingers"
    ]
  },
  {
    "id": "glue",
    ...
    "height": 0.96,
    "components": [
      "multi-head electronic glue",
      "side glue arrangement",
      "glue line verification"
    ]
  },
  {
    "id": "fold",
    "label": "Folding/trombone",
    "x": 7.05,
    "height": 0.86,
    "components": [
      "left/right carriers",
...
function build(T,options={}){if(!T)throw new Error(MACHINE_ID+' requires THREE');const root=new T.Group();root.name=MACHINE_ID;root.userData={machineId:MACHINE_ID,name:"FOLDER GLUER 3",model:"BOBST MEDIA 100 II",spec:SPEC,taxonomy:taxonomy(),motions:MOTIONS,visualDNA:VISUAL_DNA,evidenceStatus:"REFERENCE_VERIFIED_MODEL_FAMILY"};const mm=materials(T);addBase(T,root,mm);addStations(T,root,mm);addServices(T,root,mm);return root;}
