...
export function buildActualFactory(layout,fleet){
 ...
 const roomGroupFor=(l,ctx)=>{
  ...
  g.userData={semantic:'V202_ROOM_FURNITURE_GROUP',roomKey:ctx.key,roomLabel:l.text,roomProgram:ctx.program,doorSide:ctx.doorSide,roomEnvelope:[ctx.minX,ctx.maxX,ctx.minY,ctx.maxY],accuracy:'ROOM_FUNCTION_LAYOUT_REFERENCE_NOT_AS_BUILT',researchVersion:'V202',functionalReferenceVisible:true};
  return g;
 };
