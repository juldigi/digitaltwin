...
export function buildActualFactory(layout,fleet){
 ...
 const buildV203RoomShell=(l,ctx)=>{
  ...
  if(cat==='CERAMIC'){
   ...
   add(0,.018,0,w>.0?.008:.008,.005,d-.16,0x868f8d,'V204_ROOM_CONCRETE_CONTROL_JOINT_REFERENCE',.22);buildingDetailStats.v204FloorFinishJoints++;
  }
...
emptyPalletStack(93.2,84.8,4,'RMS');mobilePaperTrolley(92.9,76.8,'RMS');floorScale(93.0,72.8,'RMS');
 ...
 root.userData={baselineId:layout.baselineId,dwgFidelity:layout.dwgFidelity||null,buildingDetailPass:'V203_FULL_ROOM_SHELL_AND_AUDITED_FURNITURE_REALISM',researchVersion:'V204',researchSourceCount:V203_SOURCE_STATS.total,uniqueResearchUrls:V203_SOURCE_STATS.uniqueUrls,buildingDetailStats,utilityRouting,
