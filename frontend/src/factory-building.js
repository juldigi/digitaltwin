...
export function buildActualFactory(layout,fleet){
 ...
 root.userData={baselineId:layout.baselineId,buildingDetailPass:'V142_FACTORY_ARCHITECTURAL_REALISM',researchVersion:'V142',researchSourceCount:V142_SOURCE_STATS.total,uniqueResearchUrls:V142_SOURCE_STATS.uniqueUrls,buildingDetailStats,utilityRouting,
  architecturalEvidenceBoundary:{
   ...
   realismReferences:['CONCRETE_CONTROL_JOINT_GRID','COLUMN_BASE_PLATES_AND_ANCHORS','PANEL_OR_CONTROL_JOINT_RHYTHM','PORTAL_SECONDARY_STEEL','LINEAR_LIGHTING','GUTTER_DOWNPIPE_SPACING','WIDE_DOOR_HARDWARE','DOCK_LEVELLER_AND_PROTECTION','IPAL_SERVICE_HARDWARE'],
  ...
  assumptions:{...data.assumptions,roofEaves:4.5,roofRidge:7,roofHeightEvidence:'USER_APPROXIMATE_MEASUREMENT',machineServiceClearance:MACHINE_SERVICE_CLEARANCE,offsetRoomClearance:1.85,wallTreatment:'SOURCE_SEGMENTS_CLIPPED_TO_SERVICE_ENVELOPE',portalTreatment:'SOURCE_PORTALS_SHIFTED_ONLY_WHEN_CLEARANCE_CONFLICTS',roomContents:'FUNCTION_SPECIFIC_VISUALIZATION_NOT_AS_BUILT_INVENTORY',architecturalRealism:'V142_REFERENCE_NOT_AS_BUILT',utilityRoutingBoundary:'COMPRESSED_AIR_AHU_PIPE_AHU_DUCT_REMAIN_TEMPLATE_ONLY_UNTIL_ROUTING_DRAWING',ipalTreatment:'OUTDOOR_OPEN_FRAME_FUNCTIONAL_RECONSTRUCTION'},
