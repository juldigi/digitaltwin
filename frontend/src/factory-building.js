...
export function buildActualFactory(layout,fleet){
 ...
 const sump=basin(33.75,110.15,1.55,1.55,'IPAL_INLET_SUMP_REFERENCE',0x486d73);buildingDetailStats.ipalSumps++;
 ...
 pipeRoute([[33.75,.46,-110.15],[33.75,.66,-108.55],[34.05,.66,-108.55]],0x4c7881,.045,'IPAL_INLET_LIFT_LINE_REFERENCE');
 ...
 root.userData={baselineId:layout.baselineId,buildingDetailPass:'V147_IPAL_PROCESS_COMPLETION_AND_CACHE_LOCK',researchVersion:'V147',researchSourceCount:V147_SOURCE_STATS.total,uniqueResearchUrls:V147_SOURCE_STATS.uniqueUrls,buildingDetailStats,utilityRouting,
