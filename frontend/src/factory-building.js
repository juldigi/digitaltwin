...
import {upgradeIpalFromPhotoEvidence} from './factory-ipal-photo-v205.js';
let fleetPromise;
...
emptyPalletStack(93.2,84.8,4,'RMS');mobilePaperTrolley(92.9,76.8,'RMS');floorScale(93.0,72.8,'RMS');
 ...
 const ipalPhotoActual=upgradeIpalFromPhotoEvidence({ipal,roofLayer:layers.roof,label,buildingDetailStats,ipalEquipment});
 ...
 return {root,layers,assets,machineBoxes,utilityRouting,update:ipalPhotoActual.update,setIpalProcessMotion:ipalPhotoActual.setProcessMotion};
}
